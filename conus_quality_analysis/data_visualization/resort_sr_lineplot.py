...
ax.set_ylabel("Mean Snow Ratio", fontsize=small)
ax.set_title("Monthly Mean Snow Ratio by Region and Water Year", fontsize=med)
ax.set_ylim(0, 17)
...
for r in data["east_west"].unique():
    ...
    ax.set_xlabel("Month", fontsize=small)
    ax.set_ylabel("Mean Snow Ratio", fontsize=small)
    ax.set_title(f"Monthly Mean Snow Ratio for {r} Region", fontsize=med)
    ax.set_ylim(0, 17)
    ax.grid(True, alpha=0.4)
